...
type Watcher struct {
	...
	// watcher re-discovers them on every poll. May be nil (scans nothing).
	reposFn func() []string
}
...
func New(gh *github.Client, store *state.Store, reposFn func() []string, trusted []string) *Watcher {
